...
// Notice the 3 sets of dots here! This correctly points to frontend/lib/api.ts
...
export default function AddBookPage() {
  ...
  return (
    <main className="max-w-3xl mx-auto py-16 px-4">
      <h1 className="text-4xl font-black text-white mb-8 tracking-tight text-center">Add New Masterpiece</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 bg-slate-900/40 backdrop-blur-md p-10 rounded-3xl border border-white/5 shadow-2xl">
        ...
        <button 
          type="submit" 
          className="w-full bg-gradient-to-r from-orange-600 to-amber-500 text-slate-950 font-black py-4 rounded-xl shadow-lg hover:shadow-orange-500/20 transition-all uppercase tracking-widest"
        >
          Publish to Library
        </button>
      </form>
