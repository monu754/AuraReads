...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    if (token && userData) {
      // Save the OAuth data and log them in instantly!
        ...
        <div className="mt-8">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-[#0a0f1c] text-slate-400 font-medium rounded-full">Or continue with</span>
            </div>
          </div>
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            <button
              type="button"
              onClick={() => window.location.href = 'https://aurareads-backend.onrender.com/api/auth/google'}
              className="flex items-center justify-center gap-3 w-full bg-slate-950/50 text-white font-bold py-3.5 rounded-xl border border-white/10 hover:bg-white/5 hover:border-white/20 transition-all shadow-lg"
            >
            ...
            <button
              type="button"
              onClick={() => window.location.href = 'https://aurareads-backend.onrender.com/api/auth/github'}
              className="flex items-center justify-center gap-3 w-full bg-slate-950/50 text-white font-bold py-3.5 rounded-xl border border-white/10 hover:bg-white/5 hover:border-white/20 transition-all shadow-lg"
            >
